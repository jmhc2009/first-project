                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('product.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="description" type="textarea" class="form-control @error('description') is-invalid @enderror" name="description" required autocomplete="current-password"></textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="priceRetail" type="number" class="form-control @error('priceRetail') is-invalid @enderror" name="priceRetail" value="{{ old('priceRetail') }}" required autocomplete="priceRetail" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="offer" type="number" class="form-control @error('offer') is-invalid @enderror" name="offer" value="{{ old('offer') }}" required autocomplete="offer" autofocus>
