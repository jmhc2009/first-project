                            ...
                            <div class="row">
                                <div class="col-md-12 order-md-2 mb-4 ">
                                                    ...
                                                    <h6 class="my-0">
                                                        ...
                                                        <span>
                                                            <small class="text-muted">
                                                                ...
                                                                <!--Subtotal-->
                                                                <b> ${{ number_format($item->price * $item->quantity) }}
                                                                </b><br><br>
                                                                        ...
                                                                        <div class="col d-flex justify-content-sm-start">
                                                                            ...
                                                                            <form action="{{ route('cart.updateitem') }}"
                                                                                ...
                                                                                <div class="container d-flex">
                                                                                    ...
                                                                                    <input
                                                                                        class="btn btn-cart input-cart btn-outline-dark d-flex justify-content-center"
                                                                                        type="number"
                                                                                        value="{{ $item->quantity }}"
                                    ...
                                    <div class="input-group">
                                        @if (auth()->check())
                                            @auth
                                                <a class="btn btn-dark btn-xs btn-block btn-cart-realizar"
                                                    href="/order/create">Realizar
                                                    pedido</a>
                                            @endauth
                                        @else
                                            <a class="btn btn-outline-dark btn-block btn-cart-realizar"
                                                href="/login">Realizar
                                                pedido</a>
                                        @endif
